...
1. **Local Authentication**: PIN/Password hash values are securely salted using standard SHA-256 with a `java.security.SecureRandom` dynamic salt block.
...
If you discover a security vulnerability in this project, please report it privately via email to the security team at **indrajithbandarasl@gmail.com** (or through private repository security advisories if enabled).

Please include:
- A description of the vulnerability.
- Step-by-step instructions (with a PoC if possible) to reproduce the vulnerability.
